...
class Language(models.Model):
    ...
    def get_absolute_url(self):
        return ('views.snippets.snippets_by_language', (), { 'slug': self.slug })
...
class Tag(models.Model):
    ...
    def get_absolute_url(self):
        return ('views.snippets.snippets_by_tag', (), { 'slug': self.slug })
    get_absolute_url = models.permalink(get_absolute_url)
...
class Snippet(models.Model):
    ...
    def get_absolute_url(self):
        return ('views.snippets.snippet_detail', (), { 'snippet_id': str(self.id) })
    get_absolute_url = models.permalink(get_absolute_url)
