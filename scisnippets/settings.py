...
TEMPLATE_DIRS = (
    ...
    os.path.join(EXTERNAL_APPS, 'cab/templates'),
    os.path.join(EXTERNAL_APPS, 'cab/templates/cab'),
    os.path.join(EXTERNAL_APPS, 'cab/templates/cab/templatetags'),
    os.path.join(EXTERNAL_APPS, 'cab/templates/ratings/templatetags'),
)
...
INSTALLED_APPS = (
    ...
    #'django.contrib.staticfiles',  #coming in 1.3
    'external_apps.cab',
